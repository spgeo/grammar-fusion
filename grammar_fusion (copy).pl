...
#	3. Augmentation of both grammars and simple union
	print "\nFusing...\n";
	#system("python start.py $bu_gram $td_gram $groundtruth 1");
	#$fu_gram = $fu_gram_base."1"; system("mv ./$fu_gram ./$fu_gram.td");	
	system("python start.py $bu_gram $td_gram $groundtruth 2");
...
#	6. Augmentation of both grammars and simple union
	print "\nFusing...\n";
	#system("python start.py $bu_gram $td_gram $groundtruth 1");	
	#$fu_gram = $fu_gram_base."1"; system("mv ./$fu_gram ./$fu_gram.bu");	
	#system("python start.py $bu_gram $td_gram $groundtruth 2");
...
#	3. Augmented TD (from BU to TD mapping) with Golden Standard Grammar
	...
	$fu_gram = $fu_gram_base."2.td"; &evaluate($fu_gram);
#	4. Augmented BU (from BU to TD mapping) with Golden Standard Grammar
	#print "Augmented BU (from BU to TD mapping)\n";
	#$fu_gram = $fu_gram_base."3.td"; &evaluate($fu_gram);
#	5. Fusion Grammar (from BU to TD mapping) with Golden Standard Grammar
	#print "Simple Union (from BU to TD mapping)\n";
	#$fu_gram = $fu_gram_base."1.td"; &evaluate($fu_gram);
...
#	7. Rule Mapping performance (from TD to BU mapping) with TD-to-BU Golden Standard Rule Mapping
	...
	print "\nFusions...\n";
#	8. Augmented TD (from TD to BU mapping) with Golden Standard Grammar
	#print "Augmented TD (from TD to BU mapping)\n";
	#$fu_gram = $fu_gram_base."2.bu"; &evaluate($fu_gram);
#	9. Augmented BU (from TD to BU mapping) with Golden Standard Grammar
	print "Augmented BU (from TD to BU mapping)\n";
	$fu_gram = $fu_gram_base."3.bu"; &evaluate($fu_gram);
#	10. Fusion Grammar (from TD to BU mapping) with Golden Standard Grammar
	#print "Simple Union (from TD to BU mapping)\n";
	#$fu_gram = $fu_gram_base."1.bu"; &evaluate($fu_gram);
...
#	--------------
	...
	#$fu_gram = $fu_gram_base."1.td"; system("mv ".$fu_gram." ".$step4_path); system("mv ./".$fu_gram."_".$groundtruth.".lexsem ".$step4_path); system("mv eval_".$fu_gram." ".$step4_path); system("mv ".$eval_dir."eval_".$fu_gram.".L1_1L2_1.results.csv ".$step4_path); 
	...
	$fu_gram = $fu_gram_base."3.td"; system("mv ".$fu_gram." ".$step4_path); system("mv ./".$fu_gram."_".$groundtruth.".lexsem ".$step4_path); system("mv eval_".$fu_gram." ".$step4_path); system("mv ".$eval_dir."eval_".$fu_gram.".L1_1L2_1.results.csv ".$step4_path); 
	#$fu_gram = $fu_gram_base."1.bu"; system("mv ".$fu_gram." ".$step4_path); system("mv ./".$fu_gram."_".$groundtruth.".lexsem ".$step4_path); system("mv eval_".$fu_gram." ".$step4_path); system("mv ".$eval_dir."eval_".$fu_gram.".L1_1L2_1.results.csv ".$step4_path); 
	$fu_gram = $fu_gram_base."2.bu"; system("mv ".$fu_gram." ".$step4_path); system("mv ./".$fu_gram."_".$groundtruth.".lexsem ".$step4_path); system("mv eval_".$fu_gram." ".$step4_path); system("mv ".$eval_dir."eval_".$fu_gram.".L1_1L2_1.results.csv ".$step4_path); 
